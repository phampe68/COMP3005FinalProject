...
--publisher
INSERT INTO Publisher (publisherID,name,address,email,phoneNumber) values (0,'Random Book Publishing Co.','734 Random Street','contact@rbps.com','0118 999 881 999 119 725 3');
...
--storeorder
INSERT INTO storeorder (orderNumber,shippingAddress,courier,deliveryStatus,locationInTransit,dtime,userID) values (0,'321 Avenue Street','Courier Courier Services',false,'Warehouse','2022-12-12',0);
